...
| Fase 61 — conectividade GTM e Ads | bootstrap de consentimento, evento `smith_consent_update`, variável e acionadores no GTM | `src/app/layout.tsx`, `src/components/consent/consent-banner.tsx`, conversa `CONECTIVIDADE GTM E ADS` | `IN_PROGRESS` |
