...
| --------------------------------- | ---------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ------------- |
| Produção                          | dados institucionais definitivos e autorização regulatória                               | bloqueios em `src/config/institution.ts` e `src/config/runtime-env.ts`                                                                          | `IN_PROGRESS` |
| Phase 60? — disaster recovery     | decisão sobre a branch e validação operacional                                           | branch mesclada em `main` no commit `453c953`; `docs/operations/backup-policy.md` e `disaster-recovery.md`                                      | `IMPLEMENTED` |
